...
const urlsToCache = [
  ...
  './css/themes.css',
  './css/responsive.css',
  './css/pictos-manager.css',
  './css/party-composer.css',
  './css/party-synergy.css',
  './css/map.css',
  './css/pictos.css',
  './css/damage-calculator.css',
  './css/boss-tracker.css',
  './css/build-comparison.css',
  './css/build-guides.css',
  './css/team-optimizer.css',
  './css/achievement-tracker.css',
  './js/app.js',
  ...
  './data/weapons.json',
  './data/weapons-accurate.json',
  './data/pictos.json',
  './data/pictos-accurate.json',
  './data/luminas.json',
  './data/collectibles.json',
  './data/collectibles-accurate.json',
  './data/synergies.json',
  './data/bosses-accurate.json',
  './data/map-data.json',
  './manifest.json',
